...
namespace YourWebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IHmacAuthorizationProvider>(_ => new
            MemoryHmacAuthenticationProvider(hmacAuthenticatedApps));
            ...
            services
                    .AddAuthentication(o =>
                    {
                     ...
                     .AddHmacAuthentication(HmacAuthenticationDefaults.AuthenticationScheme,
                     "HMAC Authentication", options =>
                     {
                         //options.AuthorizationProvider =
                         //new MemoryHmacAuthenticationProvider(hmacAuthenticatedApps);
                     });

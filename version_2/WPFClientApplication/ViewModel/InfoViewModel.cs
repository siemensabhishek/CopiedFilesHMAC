...
namespace WPFClientApplication.ViewModel
{
    public class InfoViewModel : ViewModelBase
    {
        public InfoViewModel()
        {
            ...
            TrackActivity();
            CustomerEditDetails();
            string _tokenpara = GetName(MainWindow.token);
            string tokepara2 = _tokenpara;
        ...
        public string GetName(string token)
        {
            ...
            string _expTime = _token.Claims.First(claim => claim.Type == "exp").Value;
            string issTime = _token.Claims.First(claim => claim.Type == "nbf").Value;
            return _expTime;
        }
